...
const CreatePost = () => {
  ...
  const generateImage = async () => {
    if (form.prompt) {
      try {
        ...
        const response = await fetch('https://ai-image-generator-server-beg8.onrender.com/api/v1/dalle', {
          method: 'POST',
          headers: {
  ...
  const handleSubmit = async (event) => {
    ...
    if (form.prompt && form.photo) {
      ...
      try {
        const response = await fetch('https://ai-image-generator-server-beg8.onrender.com/api/v1/post', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
